...
const BASE_LINKS = [
  { href: "/base1", label: "ชุดคำถามที่ 1", sub: "ฐานที่ 1" },
  { href: "/base2", label: "ชุดคำถามที่ 2", sub: "ฐานที่ 2" },
  { href: "/base3", label: "ชุดคำถามที่ 3", sub: "ฐานที่ 3" },
  { href: "/base4", label: "ชุดคำถามที่ 4", sub: "ฐานที่ 4" },
] as const;
